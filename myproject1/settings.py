...
SECRET_KEY = 'django-insecure-586o%e9qkpv4yv^=%y#t0g&wjo8$mku95ol2adh&0uhf(i-mhm'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Research Grant & Funding Management System API',
    'DESCRIPTION': (
        'Enterprise-grade REST API for managing research grants, proposals, '
        'budgets, milestones, reports, and notifications. '
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'grants_system.log',
            'formatter': 'verbose',
        },
        'request_file': {
            'class': 'logging.FileHandler',
