    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('GRANT_MANAGER', 'Grant Manager'), ('REVIEWER', 'Reviewer'), ('RESEARCHER', 'Researcher / Principal Investigator'), ('FINANCE_OFFICER', 'Finance Officer')], db_index=True, default='RESEARCHER', max_length=20)),
